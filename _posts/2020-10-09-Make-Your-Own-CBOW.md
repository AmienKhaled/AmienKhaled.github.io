...
<p dir='rtl'>
تسمى الكلمة الماد التنبؤ بها ب (Context word)، وتسمى الكلمات المحيطة بالكلمة من اليمين و اليسار بال (Context Word) ، عدد الكلمات المستخدم على  اي جانب من بال (context half-size)، ويرمز لها بالرمز (C) ، ويطلق على مجموع (Cotext word + center word) بال (windows) ويتم حسابه باستخدام هذة المعادلة $$2*c + 1$$
مثال :
</p>
<div dir='rtl' class='notice--success'>
